...
<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dengue fever are serious worldwide health issues. Water storage is critical in areas where pure water is scarce. Although fecal contamination of stored water also serves as a breeding ground for dengue vector mosquitoes. As a result, poor home water management and sanitation are possible risk factors for both illnesses. Little is known about the role of stored water in the combined risk of dengue, but it would be critical to create coordinated control and management measures. Even less is known about the impact of including disease control in educational settings. The goal of this experiment was to see if treatments for dengue fever will significantly reduce dengue entomological risk factors in rural primary schools.</p>
